...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center h-25 w-auto  m-2  py-5 mx-8 sm:mx-20 xl:mx-32'>
      ...
      <button onClick={() => navigate('/admin')} className='bg-purple-500 text-white py-2 px-4 rounded-full hover:bg-purple-600 transition duration-300 cursor-pointer flex items-center'>
